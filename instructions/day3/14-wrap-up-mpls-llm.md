...
| รายงานฉบับสมบูรณ์ + สื่อนำเสนอ | diagram ใน `day0/03-architecture.md` ใช้ต่อได้ |
...
| Qwen3.5 35B-A3B หรือ GPT-OSS 120B | 120B ต้องการ GPU มากกว่ามาก ต้องวางแผนล่วงหน้า |
